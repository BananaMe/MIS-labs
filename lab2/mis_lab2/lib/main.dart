          ...
          actions: [
            ...
            TextButton(
              ...
              child: const Text('Confirm',
                  style: TextStyle(
                      backgroundColor: Color.fromRGBO(106, 168, 79, 1), color: Color.fromRGBO(241, 115, 115, 1)))
            ),
          ],
        );
      },
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: const Text('Cancel',
                  style: TextStyle(
                      backgroundColor: Color.fromRGBO(106, 168, 79, 1),
                      color: Color.fromRGBO(241, 115, 115, 1))),
            ),
            TextButton(
                onPressed: () {
                  _editClothes(index);
